...
object ActionSettings : Preferences {
    ...
    var needVibrate: Boolean by preference<Boolean>("needVibrate")
}

enum class GESTURE(private val key: String, val label: String) : Preferences by ActionSettings {
    ...
    DOUBLE_CLICK("double_click", "双击") {
        override var action: Int by preference(MockAction.NONE)
    },
    SWIPE_LEFT("left", "左滑") {
